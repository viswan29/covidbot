...
def bot():
    ...
    if 'A' in incoming_msg:
        ...
        if r.status_code == 200:
            ...
            text = 'I could not retrieve the results at the moment, sorry'
        msg.body(text)
        responded=True
    ...
    if 'F' in incoming_msg or 'spreads' in incoming_msg or 'cause' in incoming_msg:
